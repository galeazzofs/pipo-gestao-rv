...
const Login = () => {
  const { user, loading, signInWithMagicLink, signInWithPassword, checkIfAdmin } = useAuth();
    ...
    <div className="min-h-screen bg-background px-4 py-12 flex items-center justify-center">
      <div className="w-full max-w-md">
        ...
        <header className="mb-8 text-center">
          <h1 className="text-2xl font-bold text-foreground md:text-3xl">ComissõesPro</h1>
          ...
          {emailSent ? (
            ...
            <form onSubmit={handlePasswordSubmit}>
              ...
              <button
                ...
                className="btn-primary w-full gap-2 items-center justify-center flex flex-row text-center border-0 rounded-sm"
              >
                {isSubmitting ? (
                  <>
              ...
              <div className="mb-6">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    required
                    className="input-field pl-10"
                    placeholder="email@piposaude.com.br"
                  />
                </div>
              </div>
